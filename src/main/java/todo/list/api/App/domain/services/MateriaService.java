...
public class MateriaService {
    ...
    public ResponseEntity<DadosListagemQuestoesDTO> adicionarQuestoes(@Valid DadosCriacaoQuestaoDTO dadosQuestao, Long idProva, Long idMateria, HttpServletRequest request) {
