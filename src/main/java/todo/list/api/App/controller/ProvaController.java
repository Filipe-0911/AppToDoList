...
public class ProvaController {
    ...
    @Transactional
    @PutMapping("/{idProva}")
    public ResponseEntity<DadosListagemProvaDTO> atualizarProva(@PathVariable Long idProva, @RequestBody @Valid DadosCriacaoProvaDTO dadosProva, HttpServletRequest request) throws Exception {
        return provaService.atualizarProva(idProva, dadosProva, request);
    }
}
